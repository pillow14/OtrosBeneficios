...
namespace Cl.Ing.Pensiones.Beneficios.Bel
{
    ...
    /// </summary>
    public class CargaTraspasoPrimaDos : ObjetoNegocio
    {

        #region Miembros

            private int traspasoPrimaDosID = 0;
            ...
            private int numeroTramitePrima = 0;
            private int numeroTipoProducto = 0;
            private int numeroTramitePension = 0;
            private int numeroTramitePensionDos = 0;
            private int valorMLmontoTraspasoPrima = 0;
            ...
            //Miembros agregados segun Requerimiento RQ-1731//
        ...
        /// <summary>
        /// Obtiene o asigna el id de Traspaso Prima dos
        /// </summary>
        public int TraspasoPrimaDosID
        {
            set{ traspasoPrimaDosID = value; }
            get{ return traspasoPrimaDosID; }
        }
        ...
        public ValidationResults Validacion
        {
            get
            {
                Validator<CargaTraspasoPrimaDos> validador = ValidationFactory.CreateValidator<CargaTraspasoPrimaDos>(this.ClaveRegla);
        ...
        /// <summary>
        /// Crea una nueva instancia de la clase CargaTraspasoPrimaDos
        /// </summary>
        public CargaTraspasoPrimaDos()
        {
            this.ClaveRegla = "ReglasEntidadCargaTraspasoPrimaDos";
        }
