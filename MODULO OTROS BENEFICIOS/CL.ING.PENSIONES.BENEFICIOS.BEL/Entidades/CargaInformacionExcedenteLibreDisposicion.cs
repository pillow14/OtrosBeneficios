...
namespace Cl.Ing.Pensiones.Beneficios.Bel
{
    ...
    /// </summary>
    public class CargaInformacionExcedenteLibreDisposicion : ObjetoNegocio
    {

        #region Miembros

            private int libreDisposicionID = 0;
            ...
            private int codigoAgenciaCobro = 0;
            ...
            private int numeroTramiteExcedente = 0;
            private int numeroTramitePension = 0;
            private int estadoPagoELD = 0;
            ...
            private int secuenciaProceso = 0;
            ...
            private int numeroTramiteLibreDisposicion = 0;
        ...
        /// <summary>
        /// Obtiene o asigna el id de Libre Disposicion
        /// </summary>
        public int LibreDisposicionID
        {
            set{ libreDisposicionID = value; }
            get{ return libreDisposicionID; }
        }
        ...
        /// <summary>
        /// Crea una nueva instancia de la clase CargaInformacionExcedenteLibreDisposicion
        /// </summary>
        public CargaInformacionExcedenteLibreDisposicion()
        {
            this.ClaveRegla = "ReglasEntidadCargaInformacionExcedenteLibreDisposicion";
        }
